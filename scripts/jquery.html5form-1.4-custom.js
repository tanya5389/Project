 ...
 *	http://jquery.com
 *
 *  INCLUDES MODIFICATIONS BY WISDOM
 * 
 */
(function($){
    $.fn.html5form = function(options){
        ...
        $(this).each(function(){
            ...
            var defaults = {
                ...
                messages : 'en', // changed by WISDOM
                emptyMessage : false,
                emailMessage : false,
                allBrowsers : true, 
                resetAfterSend : true, // added by WISDOM
                resetCreditCard : true, // added by WISDOM
                disableSubmit : false
            };   
            ...
            function fillInput(input){
            	/*
                //Remove Firefox red box-shadow on required fields
                if($.browser.mozilla){
                    input.css({
                        '-moz-box-shadow' : 'none',
                        'box-shadow' : 'none'  
                        ...
                        if(opts.async){
                            ...
                            $.ajax({
                                ...
                                success : function(data){
                                    ...
                                    //Reset form
                                    if(opts.resetAfterSend) { // added by WISDOM
	                                    $(input).val('');
                                    ...
                                    if(opts.resetCreditCard) { // added by WISDOM
